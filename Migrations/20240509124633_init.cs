        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookDescription = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BookCheckouts_Books_FkBookId",
                        column: x => x.FkBookId,
                        principalTable: "Books",
                        principalColumn: "BookId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookCheckouts_Customers_FkCustomerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookCheckouts_FkBookId",
                table: "BookCheckouts",
                column: "FkBookId");

            migrationBuilder.CreateIndex(
                name: "IX_BookCheckouts_FkCustomerId",
                table: "BookCheckouts",
                column: "FkCustomerId");
        }
